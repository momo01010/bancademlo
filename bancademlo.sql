...
--llamado de clientes, cuentas y balances
select 
c.id,
c.first_name,
c.last_name,
...
--llamada de las cuentas y tipos de cuentas
select 
a.account_no,
a.client_id,
...
--llamada de las transacciones, sus montos y sus tipos 
select 
t.id as transacción,
t.amount as monto,
tt."name" as tipo_de_transacción
from transactions as t
left join transactions_types as tt on t.transaction_type = tt.id 

-- llamada a las transacciones, sus montos y todos los tipos
select 
t.id as transacción,
t.amount as monto,
tt."name" as tipo_de_transacción
...
create view v_clients_accounts as select
c.id,
c.first_name,
c.last_name,
c.email,
...
create view v_accounts_types as select
a.account_no,
a.client_id,
at1."name" as tipo_de_cuenta
from accounts as a
...
create view v_transactions_detail as select 
t.id as transacción,
t.amount as monto,
tt."name" as tipo_de_transacción
from transactions as t
...
create view v_transations_types_detail as select 
t.id as transacción,
t.amount as monto,
tt."name" as tipo_de_transacción
from transactions as t
